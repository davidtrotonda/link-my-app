/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare-smart-redirect/wrangler.jsonc cloudflare-smart-redirect/worker-configuration.d.ts` (hash: f9ed8958f56c6416a591c945f652bf1c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "FIREBASE_DATABASE_URL" | "FIREBASE_HOSTING_ORIGIN" | "EDGE_CACHE_TTL_SECONDS" | "REDIRECT_INTERSTITIAL_DELAY_MS" | "LEGACY_CLICK_FALLBACK">> {}
}
