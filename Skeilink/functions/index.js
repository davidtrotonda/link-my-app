...
const firebaseHostingInvoker =
  "service-499636102523@gcp-sa-firebase.iam.gserviceaccount.com";

const allowedOrigins = [
  "https://link-my.app",
  "https://www.link-my.app",
  "https://skeilink.web.app",
  /^http:\/\/localhost:\d+$/,
  /^http:\/\/127\.0\.0\.1:\d+$/,
];
...
admin.initializeApp({
  databaseURL:
    ...
    "https://skeilink-default-rtdb.europe-west1.firebasedatabase.app",
});
...
exports.createCheckoutSession = onRequest(
  {
    region: "europe-west1",
    cors: allowedOrigins,
    invoker: [firebaseHostingInvoker],
